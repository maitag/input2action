...
class SimpleConfig extends Application {	
	...
	public override function onWindowCreate ():Void 
	{
		...
		var actionMap:ActionMap = [
			...
			"moveUp"    => { action:(isDown, player:Int)->trace('moveUp   - ${(isDown) ? "DOWN" : "UP"}, player:$player'), up:true },
			"moveDown"  => { action:(isDown, player:Int)->trace('moveDown - ${(isDown) ? "DOWN" : "UP"}, player:$player'), up:true },
